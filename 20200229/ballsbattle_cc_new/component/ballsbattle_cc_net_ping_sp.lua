...
function BBCCPingSpComponent:__init__(mainPanel)
    ...
    self.pingRobotLabel = self.pingNode.pingRobotLabel
...
function BBCCPingSpComponent:OnUpdate()
    ...
    self.pingLabel:SetString(tostring(constant_ballsbattle_cc.SimulateDelay)..'ms')
    self.pingRobotLabel:SetString(tostring(constant_ballsbattle_cc.RobotDelay)..'ms')
