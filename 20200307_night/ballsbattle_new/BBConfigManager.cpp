...
int BBConfigManager::minMyCatchUpTicks = 3;
int BBConfigManager::maxMyCatchUpTicks = 5;
int BBConfigManager::minOtherCatchUpTicks = 4;
int BBConfigManager::maxOtherCatchUpTicks = 20;
double BBConfigManager::otherCatchRate = 1 / 6.0;
...
double BBConfigManager::massToSpeedControllerRate = 1.0;
...
{
	BBConfigManager::minMyCatchUpTicks = cnt;
}

void BBConfigManager::SetMaxCatchUpTicks(int cnt)
{
	BBConfigManager::maxMyCatchUpTicks = cnt;
}

void BBConfigManager::SetMinOtherCatchUpTicks(int cnt)
{
	BBConfigManager::minOtherCatchUpTicks = cnt;
}

void BBConfigManager::SetMaxOtherCatchUpTicks(int cnt)
{
	BBConfigManager::maxOtherCatchUpTicks = cnt;
}

void BBConfigManager::SetOtherCatchSpeedRate(double rate)
{
	BBConfigManager::otherCatchRate = rate;
}
...
void BBConfigManager::SetMassToSpeedControllerRate(double rate)
{
	BBConfigManager::massToSpeedControllerRate = rate;
}