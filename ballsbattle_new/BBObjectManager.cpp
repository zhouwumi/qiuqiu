...
Spore* BBObjectManager::CreateSpore(PlayerNode* sourceNode)
{
	...
	BBVector moveVec = BBVector::GetFixedVetor2(sourceNode->Direction, sourceNode->GetRadius());
	...
	newSpore->CalculateInitMoveParams(newSpore->GetRadius(), BBConst::SporeStopFrame, BBConst::SporeInitSpeed, BBConst::SporeStopSpeed);
	return newSpore;
}