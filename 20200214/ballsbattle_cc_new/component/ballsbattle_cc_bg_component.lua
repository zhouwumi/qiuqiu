...
function BBCCBgComponent:GetDoubleVisibleRect()
	-- local distanceX = self.maxLocalPoint.x - self.minLocalPoint.x
	-- local distanceY = self.maxLocalPoint.y - self.minLocalPoint.y

	-- local minX = self.minLocalPoint.x - distanceX / 2
	-- local maxX = self.maxLocalPoint.x + distanceX / 2
	-- local minY = self.minLocalPoint.y - distanceY / 2
	-- local maxY = self.maxLocalPoint.y + distanceY / 2
	-- return ccp(minX, minY), ccp(maxX, maxY)
	return self:GetVisibleRect()
end