...
public:
	...
	inline void SetCanEatFood(bool can)
	{
		canEatFood = can;
	}
	inline bool GetCanEatFood()
	{
		return canEatFood;
	}

	inline void SetCanEatSpiky(bool can)
	{
		canEatSpiky = can;
	}

	inline bool GetCanEatSpiky()
	{
		return canEatSpiky;
	}
	...
	unsigned int GetLuaCrcIdx(unsigned int uid, int idx);
