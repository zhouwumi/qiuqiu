...
public:
	...
	static bool FixCircleDefaultRect(double circleX, double circleY, int radius, double& fixedX, double& fixedY);
	...
	static unsigned int bb_get_crc_best_value(double value);
